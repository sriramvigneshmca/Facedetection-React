...
const Signup=({OnRouterChange})=>{
  ...
  <form class="measure">
    ...
    <div class="">
      <input class="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" onClick={()=>{OnRouterChange("signin")}} type="submit" value="Sign Up"/>
    </div>
